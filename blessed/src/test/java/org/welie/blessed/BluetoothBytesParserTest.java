...
import static org.welie.blessed.BluetoothBytesParser.FORMAT_FLOAT;
import static org.welie.blessed.BluetoothBytesParser.FORMAT_SFLOAT;
import static org.welie.blessed.BluetoothBytesParser.FORMAT_SINT16;
import static org.welie.blessed.BluetoothBytesParser.FORMAT_SINT32;
import static org.welie.blessed.BluetoothBytesParser.FORMAT_SINT8;
import static org.welie.blessed.BluetoothBytesParser.FORMAT_UINT16;
import static org.welie.blessed.BluetoothBytesParser.FORMAT_UINT32;
import static org.welie.blessed.BluetoothBytesParser.FORMAT_UINT8;
import static org.welie.blessed.BluetoothBytesParser.bytes2String;
...
public class BluetoothBytesParserTest {
    ...
    public void parseLong_BigEndianTest() {
        ...
        assertEquals(257L, parser.getLongValue());

        parser = new BluetoothBytesParser(new byte[]{1,1,1,1,1,1,1,1}, BIG_ENDIAN);
        assertEquals(72340172838076673L, parser.getLongValue());
    ...
    public void setStringTest() {
        ...
        boolean result = parser.setString(null);
        assertFalse(result);

        result = parser.setString(null, 0);
        assertFalse(result);
    }
